...
import { Star, Trophy, Plus, Search, Filter, ArrowLeft, MoreVertical, BookOpen, Award } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10" dir="rtl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">الاختبارات والامتحانات</h1>
          <p className="text-gray-500 mt-1">أدر اختبارات قياس المعرفة والامتحانات الشاملة لطلابك.</p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-black text-gray-900 flex items-center">
            <Star className="w-6 h-6 ml-3 text-amber-500 fill-amber-500" />
            اختبارات الجلسات
          </h2>
          <div className="space-y-4">
            {quizzes.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3 space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">الجلسة: {quiz.lesson.title}</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                    <div className="flex space-x-6 space-x-reverse">
                      <div className="text-center">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">التقديمات</p>
                        <p className="font-bold text-gray-900">{quiz.submissions.length}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">متوسط الدرجة</p>
                    ...
                    <Link 
                      ...
                      className="p-3 bg-gray-50 text-gray-400 rounded-xl hover:bg-indigo-600 hover:text-white transition-all transform rotate-180"
                    >
              ...
              <div className="p-12 text-center bg-gray-50 rounded-[2.5rem] border-2 border-dashed border-gray-200">
                <p className="text-gray-400 font-bold">لم يتم إنشاء أي اختبارات بعد.</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="space-y-6">
          <h2 className="text-xl font-black text-gray-900 flex items-center">
            <Trophy className="w-6 h-6 ml-3 text-indigo-600" />
            امتحانات البرنامج
          </h2>
          <div className="space-y-4">
            {tests.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3 space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">يضم {test.testLessons.length} جلسات</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                    <div className="flex space-x-6 space-x-reverse">
                      ...
                      <div className="text-center">
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">الصعوبة</p>
                        <p className="font-bold text-indigo-600">متقدم</p>
                      </div>
                    </div>
                    <Link 
              ...
              <div className="p-12 text-center bg-gray-50 rounded-[2.5rem] border-2 border-dashed border-gray-200">
                <p className="text-gray-400 font-bold">لم يتم إنشاء امتحانات للبرنامج بعد.</p>
              </div>
            )}
          </div>
        </div>
